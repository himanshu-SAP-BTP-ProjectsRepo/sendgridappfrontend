		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Incresol Mail Status",
									"targetURL": "#comincresolsendgridfrontendapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comincresolsendgridfrontendapplication-display": {
								"semanticObject": "comincresolsendgridfrontendapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.incresol.sendgridfrontendapplication",
									"url": sap.ui.require.toUrl("com/incresol/sendgridfrontendapplication")
								}
							}
						}
					}
